...
\address{Rua Conselheiro Lobato 390, 2ºESQ, 4705-089 Braga, Portugal}

\mobile{(+351) 926-750-736}
\email{marysedestevao29@gmail.com}
% \homepage{www.posquit0.com}
%\github{marysedestevao}
\linkedin{marysedestevao}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
\skype{marysedestevao}
% \reddit{reddit-id}
...
\makecvfooter
  {\today}
  {Maryse Estevão~~~·~~~Curriculum Vitae}
  {\thepage}
